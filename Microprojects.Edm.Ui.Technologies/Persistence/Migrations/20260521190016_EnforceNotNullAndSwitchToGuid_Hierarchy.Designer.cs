...
namespace Microprojects.Edm.Ui.Technologies.Persistence.Migrations
{
    ...
    [Migration("20260521190016_EnforceNotNullAndSwitchToGuid_Hierarchy")]
    partial class EnforceNotNullAndSwitchToGuid_Hierarchy
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microprojects.Edm.Ui.Technologies.Models.Device", b =>
                {
                    ...
                    b.HasOne("Microprojects.Edm.Domain.Meta", "Meta")
                        .WithOne()
                        .HasForeignKey("Microprojects.Edm.Ui.Technologies.Models.Device", "Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microprojects.Edm.Ui.Technologies.Models.Host", b =>
                {
                    ...
                    b.HasOne("Microprojects.Edm.Domain.Meta", "Meta")
                        .WithOne()
                        .HasForeignKey("Microprojects.Edm.Ui.Technologies.Models.Host", "Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microprojects.Edm.Ui.Technologies.Models.Process", b =>
                {
                    ...
                    b.HasOne("Microprojects.Edm.Domain.Meta", "Meta")
                        .WithOne()
                        .HasForeignKey("Microprojects.Edm.Ui.Technologies.Models.Process", "Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microprojects.Edm.Ui.Technologies.Models.Workplace", b =>
                {
                    ...
                    b.HasOne("Microprojects.Edm.Domain.Meta", "Meta")
                        .WithOne()
                        .HasForeignKey("Microprojects.Edm.Ui.Technologies.Models.Workplace", "Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
