...
import type { ItemLinkRow, UUID } from '@logistics/data/types'
        ...
        <>
            ...
            {links && (
                <Grid data={links} scrollable="none">
                    <GridColumn
                        field="sourceNomenclatureName"
                        title="Source nomenclature"
                    />
                    <GridColumn
                        field="sourceTareTypeName"
                        title="Source tare type"
                    />
                    <GridColumn
                        field="sourceTareTypeUnits"
                        title="Source units"
                    />
                    ...
                    />
                    <GridColumn
                        field="targetNomenclatureName"
                        title="Target nomenclature"
                    />
