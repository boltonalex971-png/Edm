...
export const OrderSearch = (props: OrderSearchProps) => {
    ...
    const filteredData = useMemo(() => {
        ...
        const result = orders?.filter(o => 
            ...
            o.processNomenclatureName?.toLowerCase().includes(lowerCasedFilter) ||
    ...
    return (
        <Detail
            ...
            data={{name: 'Order search', description: 'Search for orders'} as DataItem}
            subDetail={subDetail}
            card={
                <>
                    ...
                    {data &&
                        ...
                        >
                            <GridColumn field='processName' title='Process' cell={p =>
                                <LinkTextCell {...p} fieldId='processId'
                            ...
                            <GridColumn field='processNomenclatureName' title='Nomenclature' cell={p =>
                                <LinkTextCell {...p} fieldId='processNomenclatureId'
                                              onClick={(id, itemUpdate) => setSubDetail(
                                                  <NomenclatureDetail
                                                      id={id}
                            ...
                            <GridColumn field='startDate' title='Start' cell={DateCell}/>
                            <GridColumn field='dueDate' title='Due' cell={DateCell}/>
                        </Grid>
                    }
                    <div className="mt-2"/>
                </>
