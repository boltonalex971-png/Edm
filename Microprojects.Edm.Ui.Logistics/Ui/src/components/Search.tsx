import React, {type EffectCallback, ReactElement, useEffect} from "react";
...
import {Diagram3, Download, Pen, Search as SearchIcon} from "react-bootstrap-icons";
    ...
    return (
        <SmartScroll offsetTop={10} style={{display: "flex", flexDirection: "row", alignItems: 'flex-start', gap: 20}}>
            ...
            >
                ...
                <Button type={'button'} fillMode={'flat'} onClick={searchClick}><SearchIcon/> Search</Button>
