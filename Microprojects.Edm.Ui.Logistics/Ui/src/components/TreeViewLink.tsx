...
export function TreeViewLink(props: TreeViewLinkProps) {
    ...
    const [[data, setData], loading, error] = useGet<TreeDataItem[]>(`${props.api}/hierarchy`, [props.api]);
    ...
    return (
        <div>
            <div style={{display: 'inline-flex', alignItems: 'center', width: '80%', marginBottom: '20px'}}>
                <InputGroup>
                    <InputGroupText>
