...
public class NomenclaturesController : EntriesControllerBase<Nomenclature, NomenclatureViewModel, INomenclatureService>
{
    ...
    protected override NomenclatureViewModel ToViewModel(Nomenclature entry) => entry.ToViewModel();
    protected override Nomenclature ToEntity(NomenclatureViewModel model) => model.ToEntity();
